            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(
                            text="💗ᴜᴩᴅᴀᴛᴇs💓", url=f"https://t.me/THE_UPDATE_SILENCER"
                        ),
                    ],
                    [
                        InlineKeyboardButton(
...
def Music_about_callback(update: Update, context: CallbackContext):
    ...
    if query.data == "Music_":
        query.message.edit_text(
            text=f"""
 **ʜᴇʏ ʙᴀʙʏ 🖤\n\nᴡᴇʟᴄᴏᴍᴇ ᴛᴏ {0} \n\nɪ ᴀᴍ ᴀɴ ᴀᴅᴠᴀɴᴄᴇᴅ ᴀɴᴅ  sᴜᴘᴇʀғᴀsᴛ ᴠᴄ ᴘʟᴀʏᴇʀ ᴡɪᴛʜ 24x7 ᴀᴄᴛɪᴠᴇ » ғᴏʀ ᴛᴇʟᴇɢʀᴀᴍ ᴄʜᴀɴɴᴇʟ ᴀɴᴅ ɢʀᴏᴜᴘs\n\nғᴇᴇʟ ʟᴀɢ ғʀᴇᴇ ᴛᴏ ᴀᴅᴅ ᴍᴇ ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴀɴᴅ ᴇɴᴊᴏʏ sᴜᴘᴇʀ ʜɪɢʜ ǫᴜᴀʟɪᴛʏ ᴀᴜᴅɪᴏ ᴀɴᴅ ᴠɪᴅᴇᴏ** 
""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
...
─╼⃝𖠁-----------------𖠁⃝╾─•
ᴍᴀᴅᴇ ᴡɪᴛʜ ❤  ʙʏ [ᴅᴇᴠ]("t.me/its_cute_babu")""",
                parse_mode=ParseMode.MARKDOWN,
            )
        except Unauthorized:
            LOGGER.warning(
